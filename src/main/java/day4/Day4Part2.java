...
import day4.Day4Part2.LogEntry.EntryType;
...
public class Day4Part2 {
	...
	public static void main(String[] args) throws IOException {
		...
		Collections.sort(rawGuards,(g0,g1) -> {return -Integer.compare(g0.minuteAsleepMax(),g1.minuteAsleepMax());});
	...
	static class Guard {
		...
		/**
		 * Return the minute in which the guard was asleep the most
		 * @return
		 */
		...
		/**
		 * Return the number of times a guards was asleep at the same minute
		 * @return
		 */
		public int minuteAsleepMax() {
			...
			return ArrayUtil.maximum(sleepMinuteCount);
		}
